  ...
  function setupAjax() {
    ...
    $(
      ...
      event.preventDefault();
        ...
        //console.log("url:", url);
        window.location.href = "http://localhost/MiSitioWeb/Index/#/portfolio/" + url;
          ...
          if (filters.length) {
            filters.find("a").on("click", function () {
              ...
              $.ajax({
                ...
                url: "filtro.php", // URL del archivo PHP que procesará la solicitud
                data: {data: selector}, // Parámetros que se enviarán al archivo PHP
                success: function(response) {
                  // Código que se ejecutará cuando la solicitud sea exitosa
