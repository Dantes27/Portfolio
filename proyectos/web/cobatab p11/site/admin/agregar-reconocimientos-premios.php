...
<?php
	AgregarPremiosReconocimiento($_POST['titulo'], $_POST['fecha']);
	function AgregarPremiosReconocimiento($titulo, $fecha)
	{
		$email = $_SESSION['email'];
		$password = $_SESSION['password'];
		if($email != false && $password != false){
			...
			$sentencia= "INSERT INTO premios_reconocimientos (titulo, fecha, imagen) VALUES ('".$titulo."', '".$fecha."', '".$ruta."') ";
