            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        <div class="pull-left">
                            <h4 class="text-dark h4">URL VER CALIFICACIONES</h4><br>
                            <!--<p>Recomendaciones:</p>-->
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            echo "<br>";
                            echo "<center>"; echo"<a target='_blank' href='".$fila['url_pdf']."'>"; echo"VERIFICAR URL "; echo"<i class='fa-solid fa-link'>"; echo "</i>"; echo "</a>"; echo "</center>";
                        ?>
                </div>
            </div>
        </div>
