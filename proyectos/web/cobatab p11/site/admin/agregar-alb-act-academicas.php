...
<?php
	AgragarActAcademicas($_POST['titulo_alb'], $_POST['descripcion']);
	function AgragarActAcademicas($titulo_alb, $descripcion)
	{
		$email = $_SESSION['email'];
		$password = $_SESSION['password'];
		if($email != false && $password != false){
			...
			$sentencia= "INSERT INTO act_academicas (titulo_alb, descripcion, imagen) VALUES ('".$titulo_alb."', '".$descripcion."', '".$ruta."') ";
