            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        <div class="pull-left">
                            <h4 class="text-dark h4">HIMNO COBATAB</h4><br>
                            <!--<p>Recomendaciones:</p>-->
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php
                                    $consulta="SELECT * FROM alumnos WHERE id_alumnos = 4";
                        ...
                        <?php
                            ...
                            echo "<div class='container'>";
                                echo "<iframe class='responsive-iframe' src='".$fila['url_pdf']."' frameborder='0'>"; echo"</iframe>"; 
                            echo "</div>";
                        ?>
                </div>
            </div>
