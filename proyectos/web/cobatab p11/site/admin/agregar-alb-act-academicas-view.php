...
<body>
    <form action="agregar-alb-act-academicas.php" method="POST" enctype="multipart/form-data">
            <div class="form">
                <h1>Agregar Album <i class="fa-solid fa-plus"></i></h1>
                <div class="grupo">
                    <input type="text" id="titulo_alb"  name="titulo_alb"  required><span class="barra"></span>
